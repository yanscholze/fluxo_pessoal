...
export const installmentLabels = sqliteTable(
  "installment_labels",
  {
    id: text("id").primaryKey(),
    ownerId: text("owner_id").notNull(),
  ...
  (table) => [
    uniqueIndex("installment_labels_owner_group_idx").on(table.ownerId, table.groupId),
  ],
);

export const establishmentRules = sqliteTable(
  "establishment_rules",
  {
    id: text("id").primaryKey(),
    ownerId: text("owner_id").notNull(),
  ...
  (table) => [
    uniqueIndex("establishment_rules_owner_match_idx").on(table.ownerId, table.matchText),
  ],
);

export const notificationAppRules = sqliteTable(
  ...
  (table) => [
    uniqueIndex("notification_app_rules_owner_app_idx").on(table.ownerId, table.sourceApp),
  ],
);

export const pendingAutoTransactions = sqliteTable(
  "pending_auto_transactions",
  {
    id: text("id").primaryKey(),
    ownerId: text("owner_id").notNull(),
    sourceApp: text("source_app").notNull(),
  ...
  (table) => [
    index("pending_auto_transactions_owner_status_idx").on(table.ownerId, table.reviewStatus),
  ],
);
